...
const TableData = ({ role }) => {
  ...
  // const updateAttributes = (indexList) => {
  //   if (!indexList) {
  //     console.error("indexList is undefined");
  //     return;
  //   }
  ...
  //     axios({
  //       url: `https://portal.payprocc.com/api/attributes/${item.id}`,
  //       headers: {
  ...
  //       method: "get",
  //     });
  //     console.log("Contact Data is: ", response.data);
  //     setContactFormData(response.data?.Data);
  //     console.log("Contact Table Data is : ", contactFormData);
  //   } catch (error) {
  //     console.error(error);
  //   }
  // };
  ...
  return (
    <div className="flex flex-row w-full h-[100vh]">
      {dashboard ? (
        <>
          <div className="w-[20vw] h-[100%] bg-[#111827] rounded-lg -mt-4">
            <div
              className="w-full h-20 p-5 flex items-center bg-[#374151] rounded-lg uppercase font-semibold mt-[40%] focus:outline-none cursor-pointer"
